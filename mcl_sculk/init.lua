...
--shrieker----------------------------------------------
minetest.register_node("mcl_sculk:shrieker_can_summon_w_logged", {
	...
	{
	name = "mcl_sculk_shrieker_can_summon_inner_top.png",
	animation = {
		type = "vertical_frames",
		aspect_w = 16,
		aspect_h = 16,
...
minetest.register_node("mcl_sculk:shrieker_w_logged", {
	description = S("Sculk shrieker"),
	tiles = {
	{
	name = "mcl_sculk_shrieker_top.png",
...
minetest.register_node("mcl_sculk:shrieker_can_summon", {
	description = S("Sculk shrieker"),
	tiles = {
	{
	name = "mcl_sculk_shrieker_top.png",
