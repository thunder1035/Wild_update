...
("These cannot be crafted yet only occure when get in contact of water."),
	...
	stack_max = 64,
		...
		leaves = 1, leafdecay = leafdecay_distance, deco_block = 1,
		flammable = 2, not_in_creative_inventory=1, fire_encouragement = 0, fire_flammability = 0,
		compostability = 30
	},
...
minetest.register_node("wild_update:mud", {
	...
	_doc_items_longdesc = S("Mud is a block from mangrove spwamp.It drowns player a bit inside it"),
	stack_max = 64,
	tiles = {"mcl_mud.png"},
...
minetest.register_node("wild_update:mangrove_mud_roots", {
	...
	_doc_items_longdesc = S("Muddy Mangrove Roots is a block from mangrove spwamp.It drowns player a bit inside it"),
	stack_max = 64,
	tiles = {
